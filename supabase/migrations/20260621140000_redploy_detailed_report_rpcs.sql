...
-- Desktop app uses anon key; SECURITY DEFINER + app_lodge_access() handles authorization.
REVOKE ALL ON FUNCTION public.get_booking_register_report(uuid, date, date) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_payment_transaction_report(uuid, date, date) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_cancelled_booking_report(uuid, date, date) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_refund_report(uuid, date, date) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_outstanding_balance_report(uuid, date, date) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_quotation_report(uuid, date, date) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_invoice_register_report(uuid, date, date) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_financial_exception_report(uuid, date, date) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_reconciliation_controls_report(uuid, date, date) FROM PUBLIC;

GRANT EXECUTE ON FUNCTION public.get_booking_register_report(uuid, date, date) TO anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.get_payment_transaction_report(uuid, date, date) TO anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.get_cancelled_booking_report(uuid, date, date) TO anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.get_refund_report(uuid, date, date) TO anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.get_outstanding_balance_report(uuid, date, date) TO anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.get_quotation_report(uuid, date, date) TO anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.get_invoice_register_report(uuid, date, date) TO anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.get_financial_exception_report(uuid, date, date) TO anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.get_reconciliation_controls_report(uuid, date, date) TO anon, authenticated, service_role;
