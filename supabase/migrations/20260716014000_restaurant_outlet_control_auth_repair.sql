-- Repair the first outlet-control migration's obsolete role helper reference.
-- Outlet control remains explicitly gated by the Multi-outlet POS entitlement
-- and by a manager, admin, or business-owner role.
...
begin
  perform public.app_require_feature(p_lodge_id, 'multi_outlet_pos', array['manager', 'admin', 'super_admin']);
  return query
