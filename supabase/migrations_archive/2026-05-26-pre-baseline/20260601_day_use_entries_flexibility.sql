...
begin
  ...
  insert into public.pool_day_use (
    ...
    resource_name, resource_type, service_notes,
...
create or replace function public.add_day_use_entry(payload jsonb)
returns jsonb
language sql
security definer
set search_path to 'public'
as $$
  select public.add_pool_day_use(payload);
$$;

grant execute on function public.add_day_use_entry(jsonb) to anon, authenticated;
