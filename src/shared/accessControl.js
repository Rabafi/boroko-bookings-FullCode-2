...
export const APP_FEATURES = [
  ...
  'staff_basic',
  'prepayments_basic',
  'prepayments_management',
  'prepayments_advanced',
  'reports',
  'expenses',
  'staff',
  'pwa',
...
export const FEATURE_LABELS = {
  ...
  prepayments_management: 'Guest Deposits management',
  prepayments_advanced: 'Guest Deposits advanced controls',
...
export const CAPABILITY_LABELS = {
  ...
  'prepayments.view': 'View Guest Deposits',
  'prepayments.receive': 'Receive Guest Deposits',
  'prepayments.allocate': 'Allocate Guest Deposits',
  'prepayments.refund': 'Refund Guest Deposits',
  'prepayments.reverse': 'Reverse Guest Deposit entries',
  'prepayments.reconcile': 'Reconcile Guest Deposits',
  'prepayments.export': 'Export Guest Deposit reports',
  'prepayments.age': 'View Guest Deposit ageing',
  'prepayments.match': 'Match Guest Deposits to bookings',
  'prepayments.configure': 'Configure Guest Deposit controls',
...
Object.assign(CAPABILITY_LABELS, {
  ...
  'command_central.recovery.manage': 'Manage Command Central disposable recovery workspace'
})
...
const ROLE_CAPABILITIES = {
  ...
  finance: [
    ...
    'guests.view',
    'reports.basic_view',
    'backup.starter_export',
    'backup.starter_automation',
    'reports.view',
    'reports.export',
    'expenses.view',
    'expenses.manage',
...
const CAPABILITY_FEATURE_REQUIREMENTS = {
  'prepayments.view': 'prepayments_basic',
  'prepayments.receive': 'prepayments_basic',
  'prepayments.allocate': 'prepayments_basic',
  'prepayments.refund': 'prepayments_basic',
  'prepayments.reverse': 'prepayments_basic',
  'prepayments.reconcile': 'prepayments_management',
  'prepayments.export': 'prepayments_management',
  'prepayments.age': 'prepayments_advanced',
  'prepayments.match': 'prepayments_advanced',
  'prepayments.configure': 'prepayments_advanced',
  'reports.basic_view': 'basic_reports',
  'backup.starter_export': 'starter_backup',
  'backup.starter_automation': 'starter_backup_automation',
  'reports.view': 'reports',
  'expenses.view': 'expenses',
  'expenses.manage': 'expenses',
  'audit.view': 'audit',
  // Starter includes a deliberately narrow Users & Access surface. The full
  // staff module (permission exceptions, audit viewer, and deeper workforce
  // controls) remains Standard-only through staff.permissions and its routes.
  'staff.view': 'staff_basic',
  'staff.manage': 'staff_basic',
