...
const api = {
  ...
  users: {
    ...
    changeOwnPin: (data) => invoke('users:changeOwnPin', data),
  ...
  mesh: {
    ...
    lockTab: (tabId, operatorLabel) => invoke('mesh:lockTab', tabId, operatorLabel),
    unlockTab: (lockId) => invoke('mesh:unlockTab', lockId),
  ...
  pos: {
    ...
    discardLocalVoidRecord: (overrideId, options) => invoke('pos:discardLocalVoidRecord', overrideId, options),
    ...
    exportDeviceRecordsExcel: (filters) => invoke('pos:exportDeviceRecordsExcel', filters),
    exportDeviceRecordsPdf: (filters) => invoke('pos:exportDeviceRecordsPdf', filters),
    ...
    openDrawerPeriod: (data) => invoke('pos:openDrawerPeriod', data),
    recordCashMovement: (data) => invoke('pos:recordCashMovement', data),
    recordCashCount: (data) => invoke('pos:recordCashCount', data),
    submitDrawerPeriodCashup: (data) => invoke('pos:submitDrawerPeriodCashup', data),
    reviewDrawerPeriodCashup: (data) => invoke('pos:reviewDrawerPeriodCashup', data),
    getDrawerPeriodState: (outletId) => invoke('pos:getDrawerPeriodState', outletId),
    setOutletCashModel: (outletId, cashModel) => invoke('pos:setOutletCashModel', outletId, cashModel),
    ...
    getUnconfirmedPosUsage: () => invoke('pos:getUnconfirmedPosUsage'),
    ...
    verifyManagerPin: (data) => invoke('pos:verifyManagerPin', data),
    ...
    scanNetworkPrinters: () => invoke('pos:scanNetworkPrinters'),
  ...
  admin: {
    ...
    resetCompanyUserPin: (lodgeId, userId, pin) => invoke('admin:resetCompanyUserPin', lodgeId, userId, pin),
