...
async function run() {
  ...
  assert.match(panel, /Export Support Bundle/)
  assert.match(panel, /entry\.scope \|\| entry\.operation/)
  ...
  assert.match(reports, /Revenue report source:/)
  ...
  assert.match(appShell, /financialValidationAlerts\?\.\(3\)/)
